...
let HomePage = class HomePage {
    ...
    segmentChanged(ev) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__awaiter)(this, void 0, void 0, function* () {
            if (ev.detail.value === 'mis tickets') {
                ...
                this.mostrarNoHayDatosM = yield false;
                this.mis = true;
                ...
                this.mostrarNoHayDatos = yield false;
                this.mis = false;
                this.asignados = true;
                this.dash = false;
                this.getTicketsAsignados();
            ...
            yield (yield this.bpmService.getTicketsAsignados(this.status, this.finiC, this.ffinA, this.prioridad, this.incidentes, this.categoria)).subscribe((resp) => (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__awaiter)(this, void 0, void 0, function* () {
                if (resp.status) {
                    ...
                    if (resp.data.msg === 'No se encontraron tickets asignados.') {
                        this.mostrar = yield true;
                        this.mostrarNoHayDatos = yield true;
                    }
                }
            }));
        });
    ...
    getMisTickets() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__awaiter)(this, void 0, void 0, function* () {
            // eslint-disable-next-line max-len
            yield (yield this.bpmService.getMisTickets(this.status, this.finiC, this.ffinA, this.prioridad, this.incidentes, this.categoria)).subscribe((resp) => (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__awaiter)(this, void 0, void 0, function* () {
                if (resp.status) {
                    console.log(resp);
                    ...
                    this.alertService.presentAlert(resp.data.msg);
                    this.mostrarM = yield true;
                    this.mostrarNoHayDatosM = yield true;
                }
            }));
        });
    }
