...
let BPMService = class BPMService {
    ...
    conteoTickets(fini, ffin, sede) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${ticket}conteo_ticket&usuario=${this.datosUsuario.codigo}&fini${fini}&ffin${ffin}&sede=${sede}`);
        });
    }
    listadoTickets(status, fini, ffin, sede) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${ticket}listado_tickets_status&usuario=${this.datosUsuario.codigo}&status=${status}&fini${fini}&ffin${ffin}&sede=${sede}`);
        });
    }
    getTicket(codigo) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${ticket}ticket&codigo=${codigo}`);
        });
    }
    getTicketsAsignados(status, fini, ffin, prioridad, incidente, categoria) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${ticket}asignados&usuario=${this.datosUsuario.codigo}&categoria=${categoria}&incidente=${incidente}&prioridad=${prioridad}&status=${status}&fini=${fini}&ffin=${ffin}`);
        });
    }
    getMisTickets(status, fini, ffin, prioridad, incidente, categoria) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${ticket}mis_tickets&usuario=${this.datosUsuario.codigo}&categoria=${categoria}&incidente=${incidente}&prioridad=${prioridad}&status=${status}&fini=${fini}&ffin=${ffin}`);
        });
    }
    getSedes() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${util}lista_sedes&usuario=${this.datosUsuario.codigo}`);
        });
    }
    getSectores() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${util}lista_sector`);
        });
    }
    getAreas(sede) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${util}lista_areas&usuario=${this.datosUsuario.codigo}&sede=${sede}`);
        });
    }
    getCategorias() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${util}lista_categorias_hd`);
        });
    }
    getPrioridades() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${util}lista_prioridad_hd`);
        });
    }
    getIncidentes() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${util}lista_incidentes_hd`);
        });
    }
    guardarTicket(descripcion, incidente, prioridad, sede, sector, area) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${ticket}grabar_ticket&usuario=${this.datosUsuario.codigo}&descripcion=${descripcion}&incidente=${incidente}&prioridad=${prioridad}&sede=${sede}&sector=${sector}&area=${area}`);
        });
    }
    getStatus() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${util}lista_status_hd&usuario=${this.datosUsuario.codigo}`);
        });
    }
    getActivos() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${util}lista_activos&usuario=${this.datosUsuario.codigo}&sede&sector&area=&combo=1`);
        });
    }
    /////////////////////////////////////////////////
    comentar(comentario, codTicket) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${ticket}comentario&usuario=${this.datosUsuario.codigo}&codigo=${codTicket}&comment=${comentario}`);
        });
    }
    editar(codTicket, descripcion, incidente, prioridad, sede, sector, area) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${ticket}modificar_ticket&usuario=${this.datosUsuario.codigo}&codigo=${codTicket}&descripcion=${descripcion}&incidente=${incidente}&prioridad=${prioridad}&sede=${sede}&sector=${sector}&area=${area}`);
        });
    }
    cambiarStatus(comentario, codTicket, status) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.http.get(`https://pruebas.disatel.app${ticket}cambiar_status&usuario=${this.datosUsuario.codigo}&codigo=${codTicket}&status=${status}&observacion=${comentario}`);
        });
    }
